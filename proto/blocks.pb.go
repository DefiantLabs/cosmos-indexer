...
var file_blocks_proto_rawDesc = []byte{
	...
	0x74, 0x78, 0x42, 0x79, 0x44, 0x61, 0x79, 0x32, 0x82, 0x02, 0x0a, 0x0d, 0x42, 0x6c, 0x6f, 0x63,
...
var file_blocks_proto_depIdxs = []int32{
	8, // 0: blocks.Block.generation_time:type_name -> google.protobuf.Timestamp
	0, // 1: blocks.GetBlockInfoResponse.info:type_name -> blocks.Block
	8, // 2: blocks.TxByDay.day:type_name -> google.protobuf.Timestamp
	8, // 3: blocks.TxChartByDayRequest.from:type_name -> google.protobuf.Timestamp
	8, // 4: blocks.TxChartByDayRequest.to:type_name -> google.protobuf.Timestamp
	5, // 5: blocks.TxChartByDayResponse.tx_by_day:type_name -> blocks.TxByDay
	1, // 6: blocks.BlocksService.BlockInfo:input_type -> blocks.GetBlockInfoRequest
	3, // 7: blocks.BlocksService.BlockValidators:input_type -> blocks.GetBlockValidatorsRequest
	6, // 8: blocks.BlocksService.TxChartByDay:input_type -> blocks.TxChartByDayRequest
	2, // 9: blocks.BlocksService.BlockInfo:output_type -> blocks.GetBlockInfoResponse
	4, // 10: blocks.BlocksService.BlockValidators:output_type -> blocks.GetBlockValidatorsResponse
	7, // 11: blocks.BlocksService.TxChartByDay:output_type -> blocks.TxChartByDayResponse
