...
var file_blocks_proto_rawDesc = []byte{
	...
	0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x97, 0x06, 0x0a, 0x0d, 0x42, 0x6c, 0x6f, 0x63,
...
var file_blocks_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
...
var file_blocks_proto_depIdxs = []int32{
	34, // 0: blocks.Block.generation_time:type_name -> google.protobuf.Timestamp
	0,  // 1: blocks.GetBlockInfoResponse.info:type_name -> blocks.Block
	34, // 2: blocks.TxByDay.day:type_name -> google.protobuf.Timestamp
	34, // 3: blocks.TxChartByDayRequest.from:type_name -> google.protobuf.Timestamp
	34, // 4: blocks.TxChartByDayRequest.to:type_name -> google.protobuf.Timestamp
	...
	34, // 17: blocks.TotalTransactionsRequest.to:type_name -> google.protobuf.Timestamp
	...
	34, // 21: blocks.TotalBlocksRequest.to:type_name -> google.protobuf.Timestamp
	...
	34, // 28: blocks.SignerAddress.time:type_name -> google.protobuf.Timestamp
	...
	2,  // 42: blocks.BlocksService.BlockInfo:output_type -> blocks.GetBlockInfoResponse
	4,  // 43: blocks.BlocksService.BlockValidators:output_type -> blocks.GetBlockValidatorsResponse
	7,  // 44: blocks.BlocksService.TxChartByDay:output_type -> blocks.TxChartByDayResponse
	9,  // 45: blocks.BlocksService.TxByHash:output_type -> blocks.TxByHashResponse
	20, // 46: blocks.BlocksService.TotalTransactions:output_type -> blocks.TotalTransactionsResponse
	24, // 47: blocks.BlocksService.Transactions:output_type -> blocks.TransactionsResponse
	26, // 48: blocks.BlocksService.TotalBlocks:output_type -> blocks.TotalBlocksResponse
	28, // 49: blocks.BlocksService.GetBlocks:output_type -> blocks.GetBlocksResponse
	30, // 50: blocks.BlocksService.BlockSignatures:output_type -> blocks.BlockSignaturesResponse
	33, // 51: blocks.BlocksService.TxsByBlock:output_type -> blocks.TxsByBlockResponse
