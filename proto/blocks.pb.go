...
var file_blocks_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x34, 0x38, 0x48, 0x32,
	0xc3, 0x09, 0x0a, 0x0d, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_blocks_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
...
var file_blocks_proto_depIdxs = []int32{
	42, // 0: blocks.Block.generation_time:type_name -> google.protobuf.Timestamp
	0,  // 1: blocks.GetBlockInfoResponse.info:type_name -> blocks.Block
	42, // 2: blocks.TxByDay.day:type_name -> google.protobuf.Timestamp
	42, // 3: blocks.TxChartByDayRequest.from:type_name -> google.protobuf.Timestamp
	42, // 4: blocks.TxChartByDayRequest.to:type_name -> google.protobuf.Timestamp
	...
	42, // 18: blocks.TotalTransactionsRequest.to:type_name -> google.protobuf.Timestamp
	...
	42, // 22: blocks.TotalBlocksRequest.to:type_name -> google.protobuf.Timestamp
	...
	42, // 29: blocks.SignerAddress.time:type_name -> google.protobuf.Timestamp
	...
	2,  // 52: blocks.BlocksService.BlockInfo:output_type -> blocks.GetBlockInfoResponse
	4,  // 53: blocks.BlocksService.BlockValidators:output_type -> blocks.GetBlockValidatorsResponse
	7,  // 54: blocks.BlocksService.TxChartByDay:output_type -> blocks.TxChartByDayResponse
	9,  // 55: blocks.BlocksService.TxByHash:output_type -> blocks.TxByHashResponse
	21, // 56: blocks.BlocksService.TotalTransactions:output_type -> blocks.TotalTransactionsResponse
	25, // 57: blocks.BlocksService.Transactions:output_type -> blocks.TransactionsResponse
	27, // 58: blocks.BlocksService.TotalBlocks:output_type -> blocks.TotalBlocksResponse
	29, // 59: blocks.BlocksService.GetBlocks:output_type -> blocks.GetBlocksResponse
	31, // 60: blocks.BlocksService.BlockSignatures:output_type -> blocks.BlockSignaturesResponse
	34, // 61: blocks.BlocksService.TxsByBlock:output_type -> blocks.TxsByBlockResponse
	36, // 62: blocks.BlocksService.TransactionRawLog:output_type -> blocks.TransactionRawLogResponse
	38, // 63: blocks.BlocksService.TransactionSigners:output_type -> blocks.TransactionSignersResponse
	25, // 64: blocks.BlocksService.CacheTransactions:output_type -> blocks.TransactionsResponse
	29, // 65: blocks.BlocksService.CacheGetBlocks:output_type -> blocks.GetBlocksResponse
	40, // 66: blocks.BlocksService.CacheAggregated:output_type -> blocks.CacheAggregatedResponse
