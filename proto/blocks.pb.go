...
var file_blocks_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x06, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x32, 0xce, 0x0c, 0x0a, 0x0d, 0x42, 0x6c,
...
func file_blocks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_blocks_proto_msgTypes[47].Exporter = func(v interface{}, i int) interface{} {
		...
		file_blocks_proto_msgTypes[48].Exporter = func(v interface{}, i int) interface{} {
		...
		file_blocks_proto_msgTypes[49].Exporter = func(v interface{}, i int) interface{} {
		...
		file_blocks_proto_msgTypes[50].Exporter = func(v interface{}, i int) interface{} {
		...
		file_blocks_proto_msgTypes[51].Exporter = func(v interface{}, i int) interface{} {
		...
		file_blocks_proto_msgTypes[52].Exporter = func(v interface{}, i int) interface{} {
